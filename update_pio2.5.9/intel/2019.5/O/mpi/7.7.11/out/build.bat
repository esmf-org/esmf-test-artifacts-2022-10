...
#SBATCH -o /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_update_pio2.5.9/build.bat_%j.o
#SBATCH -e /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_update_pio2.5.9/build.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
module load intel/19.0.5.281 cray-mpich/7.7.11
...
export ESMF_DIR=/lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_update_pio2.5.9/esmf
...
module list >& /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_update_pio2.5.9/module-build.log
cd /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_update_pio2.5.9/esmf
set -o pipefail
