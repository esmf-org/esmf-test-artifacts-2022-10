...
module list >& /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_O_update_pio2.5.9/module-test.log
...
ssh cheyenne6 /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_O_update_pio2.5.9/esmpy_install.bat
...
make test 2>&1| tee /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_O_update_pio2.5.9/esmpy-test.log
deactivate
