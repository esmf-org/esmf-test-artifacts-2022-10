...
python3 -m pip install . 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_mpt_g_update_pio2.5.9/esmpy-install.log
make download 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/gfortran_10.1.0_mpt_g_update_pio2.5.9/esmpy-download.log
deactivate
