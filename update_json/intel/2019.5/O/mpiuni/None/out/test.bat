...
#SBATCH -o /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_O_update_json/test.bat_%j.o
#SBATCH -e /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_O_update_json/test.bat_%j.e
#SBATCH --time=3:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
module list >& /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_O_update_json/module-test.log
