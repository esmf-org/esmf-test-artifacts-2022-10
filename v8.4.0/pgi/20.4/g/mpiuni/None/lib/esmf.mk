...
ESMF_APPSDIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_ESMXDIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/addon/ESMX
...
ESMF_F90COMPILEPATHS=-I/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/mod/modg/Linux.pgi.64.mpiuni.default -I/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/include 
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=4 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default  -L/gpfsm/dulocal/sles12/pgi/linux86-64-llvm/20.4/libso
ESMF_F90ESMFLINKPATHS=-L/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default  -Wl,-rpath,/gpfsm/dulocal/sles12/pgi/linux86-64-llvm/20.4/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/include   -I/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/Infrastructure/stubs/mpiuni -I/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=4 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -lpthread -Wl,--no-as-needed
ESMF_CXXLINKPATHS=-L/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default  -L/gpfsm/dulocal/sles12/pgi/linux86-64-llvm/20.4/libso
ESMF_CXXESMFLINKPATHS=-L/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default  -Wl,-rpath,/gpfsm/dulocal/sles12/pgi/linux86-64-llvm/20.4/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf
ESMF_INTERNAL_MPIRUN="/discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf/src/Infrastructure/stubs/mpiuni/mpirun"

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /discover/nobackup/projects/sbu/mpotts/esmf-test/pgi_20.4_mpiuni_g_v8.4.0/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
