...
#SBATCH -o /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_g_release_8.4.0/test.bat_%j.o
#SBATCH -e /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_g_release_8.4.0/test.bat_%j.e
#SBATCH --time=3:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
module list >& /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_g_release_8.4.0/module-test.log
