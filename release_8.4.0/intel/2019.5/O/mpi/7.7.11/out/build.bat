...
#SBATCH -o /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_release_8.4.0/build.bat_%j.o
#SBATCH -e /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_release_8.4.0/build.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
export ESMF_DIR=/lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_release_8.4.0/esmf
...
module list >& /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_release_8.4.0/module-build.log
cd /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpi_O_release_8.4.0/esmf
set -o pipefail
