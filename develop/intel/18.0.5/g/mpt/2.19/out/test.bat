...
module list >& /glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_mpt_g_develop/module-test.log
...
ssh cheyenne6 /glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_mpt_g_develop/esmpy_install.bat
...
make test 2>&1| tee /glade/scratch/theurich/ESMF-Nightly-Testing/intel_18.0.5_mpt_g_develop/esmpy-test.log
deactivate
