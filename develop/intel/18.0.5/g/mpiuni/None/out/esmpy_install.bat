...
python3 -m pip install . 2>&1| tee /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_develop/esmpy-install.log
make download 2>&1| tee /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_develop/esmpy-download.log
deactivate
