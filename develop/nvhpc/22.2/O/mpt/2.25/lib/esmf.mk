...
ESMF_APPSDIR=/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/apps/appsO/Linux.nvhpc.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default
ESMF_ESMXDIR=/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/src/addon/ESMX
...
ESMF_F90LINKPATHS=-L/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default
...
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf/lib/libO/Linux.nvhpc.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf
ESMF_INTERNAL_MPIRUN="mpirun "

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/dunlap/esmf-testing/nvhpc_22.2_mpt_O_develop/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: nvhpc
