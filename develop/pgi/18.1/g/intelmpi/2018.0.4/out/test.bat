...
#SBATCH -o /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/pgi_18.1_intelmpi_g_develop/test.bat_%j.o
#SBATCH -e /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/pgi_18.1_intelmpi_g_develop/test.bat_%j.e
#SBATCH --time=1:30:00
...
module list >& /lfs4/HFIP/hfv3gfs/Mark.Potts/esmf-tests/pgi_18.1_intelmpi_g_develop/module-test.log
